...
export default {
    ...
    data() {
        return {
            ...
            downloadMenuItems: [
                ...
                {
                    label: 'As Markdown',
                    command: () => { this.downloadAsMarkdown() }
                }
            ]
        }
    },
    ...
    components: { DetailCardWithIcon, ToastUIEditor, InfoCardWithForm, AdvisoryTabMenu }
}
</script>
        ...
        <div class="col-12">
            ...
            <div class="card" v-if="dataLoaded">
                <div class="grid">
                    ...
                    <div class="col-12 md:col-3">
                        <DetailCardWithIcon title="Affected Versions" icon="fa fa-circle-exclamation" class="surface-ground"
                            :text="advisory.affected_versions"></DetailCardWithIcon>
                    </div>
                    <div class="col-12 md:col-3">
                        <DetailCardWithIcon title="Fixed Versions" icon="fa fa-screwdriver-wrench" class="surface-ground"
                ...
                <div class="grid">
                    <div class="col-12 md:col-3">
                        <InfoCardWithForm class="surface-ground w-full" title="Status" icon="fa fa-bookmark">
                            <Dropdown v-model="advisory.status" :options="statusChoices" optionLabel="title" class="w-full"
                                optionValue="value" @change="patchAdvisory({ status: advisory.status })"></Dropdown>
                        </InfoCardWithForm>
                    </div>
                    <div class="col-12 md:col-3">
                    ...
                    <div class="col-12 md:col-3">
                        <InfoCardWithForm class="surface-ground w-full" title="Severity" icon="fa fa-attention">
                            <Dropdown v-model="advisory.severity" :options="severityChoices" optionLabel="label"
                                @change="patchAdvisory({ severity: advisory.severity })" optionValue="value"></Dropdown>
                        </InfoCardWithForm>
                    </div>
                    <div class="col-12 md:col-3">
