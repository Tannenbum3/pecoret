...
<template>
    ...
    <div class="grid">
        ...
        <div class="col-6">
            <div class="flex justify-content-end">
                <Button outlined icon="fa fa-plus" label="Advisory"
                    @click="this.$router.push({ name: 'AdvisoryCreate' })"></Button>
            </div>
        </div>
    </div>
    ...
    <div class="grid">
        <div class="col-12">
            <Card>
                <template #content>
                    <DataTable paginator lazy rowHover dataKey="pk" :value="items" :rows="pagination.limit"
                        :totalRecords="totalRecords" filterDisplay="menu" :loading="loading" @sort="onSort" @page="onPage"
                        @filter="onFilter" v-if="items.length > 0"
                    ...
                    <BlankSlate v-else icon="fa fa-bugs" text="No advisories found in inbox!" title="No advisories!">
                    </BlankSlate>
                </template>
