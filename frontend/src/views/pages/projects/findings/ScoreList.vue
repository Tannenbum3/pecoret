                    ...
                    <div class="grid">
                        <div class="col-6">
                            <div class="flex flex-column gap-2">
                                ...
                                <Dropdown v-model="model.base_cvss.av" :options="cvssChoices.av"
                                    optionValue="value"
                                    @change="patchCVSS({av: this.model.base_cvss.av})"
                                    optionLabel="title">
                                </Dropdown>
                            </div>
                            ...
                            <div class="flex flex-column gap-2">
                                ...
                                <Dropdown v-model="model.base_cvss.ac" :options="cvssChoices.ac" optionLabel="title"
                                    optionValue="value"
                                    @change="patchCVSS({ac: this.model.base_cvss.ac})"
                                >
                                </Dropdown>
                            </div>
                            <div class="flex flex-column gap-2">
                                <label for="av">Privileges Required (PR)</label>
                                <Dropdown v-model="model.base_cvss.pr" :options="cvssChoices.pr" optionLabel="title"
                                    optionValue="value"
                                    @change="patchCVSS({pr: this.model.base_cvss.pr})"
                                >
                                </Dropdown>
                            </div>
                            <div class="flex flex-column gap-2">
                                <label for="av">User Interaction (UI)</label>
                                <Dropdown v-model="model.base_cvss.ui" :options="cvssChoices.ui" optionLabel="title"
                                    optionValue="value"
                                    @change="patchCVSS({ui: this.model.base_cvss.ui})"
                                >
                                </Dropdown>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="flex flex-column gap-2">
                                ...
                                <Dropdown v-model="model.base_cvss.s" :options="cvssChoices.s" optionLabel="title"
                                    optionValue="value"
                                    @change="patchCVSS({s: this.model.base_cvss.s})"
                                >
                                </Dropdown>
                            </div>
                            <div class="flex flex-column gap-2">
                                <label for="av">Confidentiality (C)</label>
                                <Dropdown v-model="model.base_cvss.c" :options="cvssChoices.cia" optionLabel="title"
                                    optionValue="value"
                                    @change="patchCVSS({c: this.model.base_cvss.c})"
                                >
                                </Dropdown>
                            </div>
                            <div class="flex flex-column gap-2">
                                <label for="av">Integrity (I)</label>
                                <Dropdown v-model="model.base_cvss.i" :options="cvssChoices.cia" optionLabel="title"
                                    optionValue="value"
                                    @change="patchCVSS({i: this.model.base_cvss.i})"
                                >
                                </Dropdown>
                            </div>
                            <div class="flex flex-column gap-2">
                                <label for="av">Availability (A)</label>
                                <Dropdown v-model="model.base_cvss.a" :options="cvssChoices.cia" optionLabel="title"
                                    optionValue="value"
                                    @change="patchCVSS({a: this.model.base_cvss.a})"
                                >
                                </Dropdown>
                            </div>
                        </div>
                    ...
                    <div class="grid">
                        <div class="col-6">
                            <div class="flex flex-column gap-2">
                                ...
                                <Dropdown v-model="model.owasp.skill_level" :options="owaspChoices.skillLevel"
                                    optionLabel="title" optionValue="value"
                                    @change="patchOWASP({skill_level: this.model.owasp.skill_level})"
                                ></Dropdown>
                            </div>
                            <div class="flex flex-column gap-2">
                                <label for="skill_level">Motive</label>
                                <Dropdown v-model="model.owasp.motive" :options="owaspChoices.motive"
                                    optionLabel="title" optionValue="value"
                                    @change="patchOWASP({motive: this.model.owasp.motive})"
                                ></Dropdown>
                            </div>
                            <div class="flex flex-column gap-2">
                                <label for="skill_level">Opportunity</label>
                                <Dropdown v-model="model.owasp.opportunity" :options="owaspChoices.opportunity"
                                    optionLabel="title" optionValue="value"
                                    @change="patchOWASP({opportunity: this.model.owasp.opportunity})"
                                ></Dropdown>
                            </div>
                            <div class="flex flex-column gap-2">
                                <label for="skill_level">Size</label>
                                <Dropdown v-model="model.owasp.size" :options="owaspChoices.size"
                                    optionLabel="title" optionValue="value"
                                    @change="patchOWASP({size: this.model.owasp.size})"
                                ></Dropdown>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="flex flex-column gap-2">
                                ...
                                <Dropdown v-model="model.owasp.ease_of_discovery" :options="owaspChoices.easeOfDiscovery"
                                    optionLabel="title" optionValue="value"
                            ...
                            <div class="flex flex-column gap-2">
                                ...
                                <Dropdown v-model="model.owasp.ease_of_exploit" :options="owaspChoices.easeOfExploit"
                                    optionLabel="title" optionValue="value"
                                    @change="patchOWASP({ease_of_exploit: this.model.owasp.ease_of_exploit})"
                                ></Dropdown>
                            </div>
                            <div class="flex flex-column gap-2">
                                <label for="skill_level">Awareness</label>
                                <Dropdown v-model="model.owasp.awareness" :options="owaspChoices.awareness"
                                    optionLabel="title" optionValue="value"
                                    @change="patchOWASP({awareness: this.model.owasp.awareness})"
                                ></Dropdown>
                            </div>
                            <div class="flex flex-column gap-2">
                                <label for="skill_level">Intrusion Detection</label>
                                <Dropdown v-model="model.owasp.intrusion_detection" :options="owaspChoices.intrusionDetection"
                                    optionLabel="title" optionValue="value"
                    ...
                    <div class="grid mt-3">
                        <div class="col-6">
                            <div class="flex flex-column gap-2">
                                ...
                                <Dropdown v-model="model.owasp.loss_of_confidentiality" :options="owaspChoices.lossOfConfidentiality"
                                    optionLabel="title" optionValue="value"
                            ...
                            <div class="flex flex-column gap-2">
                                ...
                                <Dropdown v-model="model.owasp.loss_of_availability" :options="owaspChoices.lossOfAvailability"
                                    optionLabel="title" optionValue="value"
                            ...
                            <div class="flex flex-column gap-2">
                                ...
                                <Dropdown v-model="model.owasp.loss_of_integrity" :options="owaspChoices.lossOfIntegrity"
                                    optionLabel="title" optionValue="value"
                            ...
                            <div class="flex flex-column gap-2">
                                ...
                                <Dropdown v-model="model.owasp.loss_of_accountability" :options="owaspChoices.lossOfAccountability"
                                    optionLabel="title" optionValue="value"
                        ...
                        <div class="col-6">
                            <div class="flex flex-column gap-2">
                                ...
                                <Dropdown v-model="model.owasp.financial_damage" :options="owaspChoices.financialDamage"
                                    optionLabel="title" optionValue="value"
                                    @change="patchOWASP({financial_damage: this.model.owasp.financial_damage})"
                                ></Dropdown>
                            </div>
                            <div class="flex flex-column gap-2">
                                <label for="skill_level">Reputation Damage</label>
                                <Dropdown v-model="model.owasp.reputation_damage" :options="owaspChoices.reputationDamage"
                                    optionLabel="title" optionValue="value"
                            ...
                            <div class="flex flex-column gap-2">
                                ...
                                <Dropdown v-model="model.owasp.non_compliance" :options="owaspChoices.nonCompliance"
                                    optionLabel="title" optionValue="value"
                                    @change="patchOWASP({non_compliance: this.model.owasp.non_compliance})"
                                ></Dropdown>
                            </div>
                            <div class="flex flex-column gap-2">
                                <label for="skill_level">Privacy Violation</label>
                                <Dropdown v-model="model.owasp.privacy_violation" :options="owaspChoices.privacyViolation"
                                    optionLabel="title" optionValue="value"
