...
<template>
    ...
    <div class="grid">
        <div class="col-12">
            <div class="card">
                <DataTable :paginator="true" dataKey="pk" :rowHover="true" :rows="pagination.limit" :value="findings"
                ...
                <BlankSlate v-else title="No findings!" text="No findings here!" icon="fa fa-bug"></BlankSlate>
            </div>
        </div>
    </div>
</template>