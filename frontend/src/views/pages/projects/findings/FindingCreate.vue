<script>
import ProjectVulnerabilityAutocompleteField
  from "@/components/elements/forms/ProjectVulnerabilityAutocompleteField.vue";
          ...
          <div class="p-fluid grid formgrid">
            <div class="field col-12">
              <ProjectVulnerabilityAutocompleteField v-model="model.vulnerability"
                                                     @update:severity="onVulnerabilitySeverityChange($event)"
              >
