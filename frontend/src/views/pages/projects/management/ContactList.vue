...
export default {
    ...
    methods: {
        ...
        getItems() {
            ...
            this.projectService.getContacts(this.$api, this.projectId, params).then((response) => {
...
<template>
    ...
    <div class="grid">
        ...
        <div class="col-6">
            <div class="flex justify-content-end">
                <ProjectContactCreateDialog
                    @object-created="getItems"></ProjectContactCreateDialog>
            </div>
        </div>
    </div>
    ...
    <div class="grid">
        <div class="col-12">
            <div class="card">
                <DataTable paginator lazy dataKey="pk" rowHover
                    ...
                    <Column field="name" header="Name">
                        <template #body="slotProps">
                            {{ slotProps.data.contact.first_name }} {{ slotProps.data.contact.last_name }}
                        </template>
                    </Column>
                ...
                <BlankSlate v-else icon="fa fa-id-card" title="No contacts!" text="No contacts found!"></BlankSlate>
            </div>
        </div>
    </div>
