        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="grid">
                    ...
                    <div class="col-6">
                        <div class="flex justify-content-end">
                            <Button label="Download" icon="fa fa-download" class="mr-2" :disabled="!previewDocument.pk"
                                    outlined
                                    @click="downloadDocument(previewDocument.pk)"></Button>
                            <Button label="Preview Document" icon="fa fa-plus" outlined
                                    ...
                                    @click="createPreviewDocument"></Button>
                        </div>
                    </div>
                </div>
                <DataTable paginator lazy :rowHover="items.length > 0" dataKey="pk" :totalRecords="totalRecords"
                           filterDisplay="menu"
                           :rows="pagination.limit" :value="items"
                           :loading="loading" @page="onPage" @sort="onSort" @filter="onFilter">
                    <template #empty>
                        <BlankSlate icon="fa fa-file" title="Report documents"
                                    text="No report documents found!"></BlankSlate>
                    </template>
                    ...
                    <Column header="Actions">
                        <template #body="slotProps">
                            <Button size="small" outlined icon="fa fa-download"
                                    :loading="getDocumentLoadingIndicator(slotProps.data)"
                                    :disabled="!slotProps.data.task"
                                    label="Download"
