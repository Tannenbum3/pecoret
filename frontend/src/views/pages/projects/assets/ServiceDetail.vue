            ...
            <div class="card">
                <div class="grid">
                    <div class="col-12 md:col-3">
                        <DetailCardWithIcon title="Host" icon="fa fa-server" class="surface-ground"
                            :text="model.host.name"></DetailCardWithIcon>
                    </div>
                    <div class="col-12 md:col-3">
                        <DetailCardWithIcon title="Protocol" icon="fa fa-gears" class="surface-ground"
                            :text="model.protocol"></DetailCardWithIcon>
                    </div>
                    <div class="col-12 md:col-3">
                        <DetailCardWithIcon title="Product" icon="fa fa-briefcase" class="surface-ground"
                            :text="model.product || '-'"></DetailCardWithIcon>
                    </div>
                    <div class="col-12 md:col-3">
                        <DetailCardWithIcon title="State" icon="fa fa-bookmark" class="surface-ground"
                            :text="model.state"></DetailCardWithIcon>
                    </div>
                </div>
                <div class="grid">
                    <div class="col-12">
