...
export default {
    ...
    components: { DetailCardWithIcon, WebApplicationUpdateDialog, CustomBreadcrumb }
            ...
            <div class="card">
                <div class="grid">
                    <div class="col-12 md:col-3">
                        <DetailCardWithIcon title="Base URL" icon="fa fa-earth-europe" class="surface-ground"
                            :text="model.base_url"></DetailCardWithIcon>
                    </div>
                    <div class="col-12 md:col-3">
